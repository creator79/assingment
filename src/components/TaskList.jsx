  ...
  return (
    <>
      {todos.length >= 1 ? (
          ...
          .map((todo) => {
            return (
              <div key={todo.id} className="tasklist__task">
                ...
                />
                <strong> {todo.value.toUpperCase()} </strong>- Your task has
                priority:
                {todo.priority === "low" && (
                  <span className="tasklist__priority">
                    {" "}
                ...
                <article className="tasklist__description">
                  {todo.description}
                </article>
        ...
        <p>
          You currently have no active tasks, click{" "}
          <strong style={{ textDecoration: "underline" }}>'ADD TASK'</strong> to
          add a task
        </p>
      )}
    </>
